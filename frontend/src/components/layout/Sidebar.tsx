...
const menuItems: MenuItem[] = [
  { href: '/dashboard', label: 'Gösterge Paneli', icon: LayoutDashboard, adminOnly: true },
  {
    ...
    icon: MessageSquare,
    children: [
      { href: '/inbox', label: 'Tüm Mesajlar', icon: Inbox },
      {
        href: '/inbox?filter=mine',
        label: 'Sadece bana atanan',
        icon: User,
        param: 'mine',
        agentOnly: true,
      },
  ...
  { href: '/admin/billing', label: 'Abonelik & Fatura', icon: CreditCard, adminOnly: true, separator: true },
