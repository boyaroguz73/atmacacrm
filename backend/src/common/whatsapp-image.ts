...
const MAX_WA_IMAGE_BYTES = 5 * 1024 * 1024; // 5 MB
const MAX_DIMENSION = 4096;

// Formats that can be sent as-is without re-encoding
 ...
 * - Sadece limit aşımında sıkıştırma yapılır; kalite 95'ten başlar, adım adım düşer.
 */
export async function optimizeImageBufferForWhatsapp(buf: Buffer): Promise<{
  ...
  // Boyut küçültme (önce uygula, ardından kalite ayarla)
  ...
  // Yüksek kaliteden başla, limite göre düşür
  let quality = 95;
